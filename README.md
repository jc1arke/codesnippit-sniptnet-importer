<h1>Introduction</h1>
<p>This was the response code as was requested by @robertbanh in order to import his scripts on http://snipt.net to CodeSnipp.it and has since grown to a actual importing script</p>
